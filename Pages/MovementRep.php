        ...
        <div class="content-wrapper" >
           ...
           <button class="close" data-dismiss="alert" aria-label="Close">×</button> <strong>تهانينا !</strong> تم العملية بنجاح
            ...
            <div class="page-heading">
                <h1 class="page-title font-weight-bold">استعلامات مشتريات الكتب</h1>
                <ol class="breadcrumb">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      ...
                                      <div class="ibox">
                                                ...
                                                <div class="ibox-head">
                                                    <div class="ibox-title">الحركات الواردة الى المستودع</div>
                                          ...
                                          <div class="ibox-body">
                                              ...
                                              <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                                  ...
                                                  <tbody>
                                                    <?php
                              			$sql = "SELECT B.name ,B.sale_price, B.author , GB.name as Group_name , RM.type_M , RM.qty_move , RM.note ,RM.id as Mid, RM.posting_datatime , U.fullname as User_name
